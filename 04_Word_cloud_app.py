...
if uploaded_file:
    ...
    # add a youtube video
    st.sidebar.video("https://www.youtube.com/watch?v=R6rfhP_jfvc")
    st.sidebar.markdown("---")
    # add author name and info
    st.sidebar.markdown("Created by: [Dr. Maaz Umar](https://github.com/Maazkhan2005/myprojects)")
    st.sidebar.markdown("Contact: [Email](mailto:maazumar2005@gmail.com)")
